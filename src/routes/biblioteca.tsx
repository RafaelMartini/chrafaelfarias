  ...
  return (
    <Shell mode="admin">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 animate-reveal [animation-delay:100ms]">
        {exercises.map((e) => (
          <div key={e.id} className="group bg-surface border border-border hover:border-accent transition-all">
            <div className="aspect-video bg-background border-b border-border grid place-items-center relative">
              ...
              <div className="absolute top-2 right-2 text-[9px] font-mono uppercase bg-background/80 border border-border px-2 py-0.5 text-accent">
                {e.category}
              </div>
            </div>
            <div className="p-5">
              ...
              <div className="mt-4 flex gap-2">
                <button className="flex-1 text-[10px] font-mono uppercase tracking-widest border border-border py-2 hover:border-accent hover:text-accent transition-colors">Editar</button>
                <button className="flex-1 text-[10px] font-mono uppercase tracking-widest border border-border py-2 hover:border-accent hover:text-accent transition-colors">Usar</button>
              </div>
            </div>
          </div>
        ))}
