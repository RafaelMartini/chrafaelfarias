      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-background/80 backdrop-blur-md border-b border-border">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="text-[10px] font-mono uppercase tracking-widest border border-border px-3 py-1.5 hover:border-accent hover:text-accent transition-colors rounded-2xl"
          >
            {mode === "admin" ? "Ver portal aluno" : "Painel admin"}
          </Link>
          <button
            onClick={() => signOut()}
            className="text-[10px] font-mono uppercase tracking-widest border border-border px-3 py-1.5 hover:border-destructive hover:text-destructive transition-colors rounded-2xl"
          >
            Sair
          </button>
